...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 15:10:42 2019
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while not gameOver:
        ...
        lettersGuessed.append(input("Guess a letter: "))
        
        getGuessedWord(secretWord, lettersGuessed)
        print() 
        if isWordGuessed(secretWord, lettersGuessed):
            print("Well done! The word was", secretWord)
            gameOver = True
        
        if maxTries <= 1:
            print("That's unfortunate! The word was", secretWord)
            gameOver = True
        else:
            maxTries -= 1
